# Note: All this code belongs to mbalestrini, licenced under https://github.com/mbalestrini/GDS2glTF/blob/main/LICENSE. I am only including this in my repo to improve user expirience
